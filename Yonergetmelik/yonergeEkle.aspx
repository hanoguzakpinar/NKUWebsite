<%@ Page Title="" Language="C#" MasterPageFile="~/Panel.Master" AutoEventWireup="true" CodeBehind="yonergeEkle.aspx.cs" Inherits="Yonergetmelik.yonergeEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
							...
							<div class="overflow-hidden mb-1">
								<h2 class="font-weight-normal text-7 mb-0" style="margin-top:10px;"><strong class="font-weight-bold">Y</strong>önerge Ekle</h2>
							</div>
