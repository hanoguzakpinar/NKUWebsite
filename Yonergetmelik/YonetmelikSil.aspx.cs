...
{
    public partial class YonetmelikSil : System.Web.UI.Page
    {
        OleDbCommand cmd;
        ...
        {
            OleDbCommand objCmd = new OleDbCommand("Select * from Belge inner join Kullanici on Kullanici.kullanici_id = Belge.kullanici_id where Belge.kategori_id=1 and Belge.kullanici_id=" + Convert.ToInt32(Session["admin"]) + "");
        ...
        protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "Sil")
            {
                ...
                cmd.ExecuteNonQuery();
                objConn.Close();
                Response.Write("<script language='JavaScript'>alert('Yönetmelik Silindi.');</script>");
                YaziGetir();
            }
        }
    }
