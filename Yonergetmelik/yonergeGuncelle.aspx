<%@ Page Title="" Language="C#" MasterPageFile="~/Panel.Master" AutoEventWireup="true" CodeBehind="yonergeGuncelle.aspx.cs" Inherits="Yonergetmelik.yonergeGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-lg-12" style="margin-top: 6%">
        <div class="overflow-hidden mb-1" style="margin-top: 6%">
            <h2 class="font-weight-normal text-7 mb-0" style="margin-top: 10px;"><strong class="font-weight-bold">Y</strong>önerge Güncelle</h2>
        </div>
