<%@ Page Title="" Language="C#" MasterPageFile="~/Panel.Master" AutoEventWireup="true" CodeBehind="YonergeSil.aspx.cs" Inherits="Yonergetmelik.YonergeSil" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 align-self-center p-static order-2 text-center">
                    ...
                    <h1 class="text-dark font-weight-bold text-8">Yönerge Sil
                    </h1>
    ...
    <div class="col-lg-12" style="margin-top: 6%">
        <div class="overflow-hidden mb-1" style="margin-top: 6%">
            <h2 class="font-weight-normal text-7 mb-0" style="margin-top: 10px;"><strong class="font-weight-bold">Y</strong>önerge Sil</h2>
        </div>
