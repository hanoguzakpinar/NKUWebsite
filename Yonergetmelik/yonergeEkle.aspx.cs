...
{
    public partial class yonergeEkle : System.Web.UI.Page
    {
        ...
        {
            objConn.Open();
            string kayit = "insert into Belge(baslik,kullanici_id,kategori_id,icerik) values (@a,@b,2,@d)";
            ...
            cmd.ExecuteNonQuery();
            objConn.Close();
            Response.Write("<script language='JavaScript'>alert('Yönerge Eklendi.');</script>");
