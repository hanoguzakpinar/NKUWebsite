...
{
    public partial class Yonetmelikler : System.Web.UI.Page
    {
        ...
        {
            OleDbCommand objCmd = new OleDbCommand("Select * from Belge inner join Kullanici on Kullanici.kullanici_id = Belge.kullanici_id where Belge.kategori_id=1");
